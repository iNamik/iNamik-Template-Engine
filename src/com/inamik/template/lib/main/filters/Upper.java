/*
 * $Id: Upper.java,v 1.3 2006-08-21 08:09:40 dave Exp $
 *
...
/**
 * Upper - Transform the filter target into uppercase.
 * <p>
 ...
 */
public final class Upper implements TemplateFilterTag
{
	/**
	 * Constructor
	 */
	...
	public TemplateVariable execute(TemplateVariable[] args) throws TemplateFilterException
	{
		...
		if (args.length != 1)
		{
			throw new TemplateFilterException("Filter upper does not accept extra parameters");
		}

		return TemplateVariable.newInstance(args[0].toString().toUpperCase());
	}
}
